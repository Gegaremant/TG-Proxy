...
* **Пресеты**: Удобные профили "Дома" и "В метро" с генерацией случайных портов, чтобы избежать блокировок или проблем с правами доступа (вместо привязки к 443/1080).
...
* `SNI_list.txt` — Список доменов для FakeTLS.
